...
<div class="row-fluid">
  <div class="container">
    <div class="span12">
		<div class="well">
			Welcome, thank your taking a look at TotemMVC.
		</div>
		<div class="span10">
			<p>
			...
			<p>
				It was developed internally to get up and running fast with our CMS Platfrom (Mojag).  It does a lot of the bootstraping for you such removing the index.php in you ht access file or making sure your assets are all in a static directory.  Some of the things we do are obvious and none of it hard it's just, well damn convient to have a modern framework that has all the resoucres you need to get up and running with 0 effort (we like 0 effort at Totem).
				</p>
				<p>
