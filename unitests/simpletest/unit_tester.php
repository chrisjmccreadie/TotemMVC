...
class UnitTestCase extends SimpleTestCase {
	...
	function assertJson($result,$message = '%s')
	{
		
		return $this->assert(new isJson(), $result, $message);
		//return(true);
	}
	
	function assertObject($result,$message = '%s')
	{
		
		return $this->assert(new isObject(), $result, $message);
		//return(true);
	}
